...
BLOG_AUTHOR = "Roy Campbell"  # (translatable)
BLOG_TITLE = "Roy Campbell is online"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://campbellis.online/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://campbellis.online/"
BLOG_EMAIL = "roy.campbell.732+online@gmail.com"
BLOG_DESCRIPTION = "an online place for me to think out loud"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/pages/accomplishments/", "Accomplishments"),
        ("/pages/projects/", "Projects"),
        ("/pages/utilities/", "Utilities"),
        ("/pages/fun-games/", "Fun & Games")
    )
}
